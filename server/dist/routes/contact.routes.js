...
import { submitContact, listContacts, getContact, updateContactStatus, deleteContact, } from "../controllers/contact.controller.js";
import { contactIdValidator, submitContactValidator, listContactsValidator, updateContactStatusValidator, } from "../validators/contact.validator.js";
const router = Router();
